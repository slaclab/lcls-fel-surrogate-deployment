# lcls-fel-surrogate-deployment

This is the main deployment repository for the `lcls-fel-surrogate-deployment` of the `lcls-fel-surrogate` model using LUME-Torch in an online environment.
...
It provides a structured approach to deploying machine learning models using [LUME-Torch](https://github.com/lume-science/lume-torch)
...
> [!IMPORTANT]  
> There is currently no validation implemented for this; user must ensure config matches the LUME-torch model and that the mapping
...
For more details, see the [lume-torch documentation](https://github.com/lume-science/lume-torch) and the [Copier documentation](https://copier.readthedocs.io/).
